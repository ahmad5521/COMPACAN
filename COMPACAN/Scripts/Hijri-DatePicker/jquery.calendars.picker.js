...
$(selector).calendarsPicker({minDate: $.calendars.newDate(2001, 1, 1),
  maxDate: $.calendars.newDate(2010, 12, 31)}) */
		...
		/** Localisations for the plugin.
			...
			@property {string} [nextStatus='الشهر التالي'] Status text for the next month command.
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				todayText: 'اليوم',
				todayStatus: 'اضهر الشهر لهذا اليوم',
				clearText: 'مسح',
				clearStatus: 'مسح',
				closeText: 'اغلاق',
				closeStatus: 'اغلاق',
				...
				weekText: 'Wk',
				weekStatus: 'الاسبوع من السنة',
				dayStatus: 'اختر DD,d M, yyyy',
				defaultStatus: 'اختر  التاريخ',
				isRTL: false
			}
		},
