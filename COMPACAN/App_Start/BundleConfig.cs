    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataPicker").Include(
                      ...
                      "~/Scripts/plugins/datapicker/bootstrap-datepicker.ar.min.js"));
            ...
            // Data mask 
            bundles.Add(new StyleBundle("~/plugins/dataMask").Include(
                        "~/Scripts/plugins/data-mask/jquery.mask.js"));

            //Lobipanel css
            bundles.Add(new StyleBundle("~/Content/plugins/lobipanel/lobipanelStyles").Include(
                      "~/Content/plugins/lobipanel/lobipanel.css"));

            //Lobipanel js
            bundles.Add(new ScriptBundle("~/plugins/lobipanel").Include(
                      "~/Scripts/plugins/lobipanel/lobipanel.min.js"));
        }
    }
}